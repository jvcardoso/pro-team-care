...
class CurrentContextResponse(BaseModel):
    ...
    effective_user_email: Optional[str] = None
    is_impersonating: Optional[bool] = None
    is_root: Optional[bool] = None
    active_role: Optional[Dict[str, Any]] = None
...
@router.get(
    "/available-profiles",
    response_model=AvailableProfilesResponse,
...
async def get_available_profiles(
    ...
    if request.method == "OPTIONS":
        return AvailableProfilesResponse(
            profiles=[], total_profiles=0, user_is_root=False
        )
    ...
    try:
        ...
        return AvailableProfilesResponse(
            ...
            user_is_root=current_user.is_system_admin if current_user else False,
        )
...
async def get_current_context(
    ...
    try:
        ...
        if not session_data:
            ...
            return {
                ...
                "user_info": {
                    ...
                    "email": (
                        getattr(current_user, "email_address", None)
                        if current_user
                        else None
                    ),
                },
        ...
        return {
            ...
            "effective_user_id": session_data.get("impersonated_user_id")
            or session_data["user_id"],
            "effective_user_email": session_data.get("impersonated_email")
            or session_data["user_email"],
