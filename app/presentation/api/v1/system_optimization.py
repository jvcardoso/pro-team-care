...
from app.infrastructure.services.system_optimization_service import (
...
async def run_performance_optimization(
    ...
    try:
        ...
        logger.info(
            f"Otimização executada: {len(optimization_results['optimizations_applied'])} aplicadas"
        )
...
async def validate_business_rules(
    ...
    try:
        ...
        logger.info(
            f"Validação executada: {validation_results['success_rate']:.2f}% sucesso"
        )
...
async def run_maintenance_cleanup(
    ...
    try:
        ...
        logger.info(
            f"Limpeza executada: {cleanup_results['cleaned_records']} registros removidos"
        )
        return {
            "timestamp": datetime.now().isoformat(),
...
async def check_table_integrity(
    ...
    try:
        ...
        return {"timestamp": datetime.now().isoformat(), "table_integrity": table_check}
