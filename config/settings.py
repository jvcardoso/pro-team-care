...
class Settings(BaseSettings):
    ...
    db_connection: str = Field(default_factory=lambda: os.getenv("DB_CONNECTION", "postgresql+asyncpg"))
    db_host: str = Field(default_factory=lambda: os.getenv("DB_HOST", "localhost"))
    db_port: int = Field(default_factory=lambda: int(os.getenv("DB_PORT", "5432")))
    db_username: str = Field(default_factory=lambda: os.getenv("DB_USERNAME", "postgres"))
    db_password: str = Field(default_factory=lambda: os.getenv("DB_PASSWORD", ""))  # ✅ Será encoded automaticamente
    db_database: str = Field(default_factory=lambda: os.getenv("DB_DATABASE", "database"))
    ...
    # ViaCEP
    viacep_base_url: str = Field(default="https://viacep.com.br/ws", env="VIACEP_BASE_URL")
    viacep_timeout: int = Field(default=10, env="VIACEP_TIMEOUT")
    
    # ReceitaWS
    receita_ws_base_url: str = Field(default="https://www.receitaws.com.br/v1", env="RECEITA_WS_BASE_URL")
