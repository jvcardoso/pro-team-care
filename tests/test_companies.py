...
class TestCompanyRepository:
    ...
    def sample_company_data(self):
        ...
        return CompanyCreate(
            ...
            emails=[
                EmailCreate(
                    email_address="contato@teste.com.br", type="work", is_principal=True
                )
            ],
            addresses=[
                AddressCreate(
    ...
    def test_phone_validation(self):
        ...
        phone = PhoneCreate(
            country_code="55", number="11987654321", type="mobile", is_whatsapp=True
        )
    ...
    def test_email_validation(self):
        ...
        email = EmailCreate(
            email_address="test@example.com", type="work", is_principal=True
        )
...
if __name__ == "__main__":
    ...
    people_data = PeopleCreate(
        person_type="PJ", name="Test Company", tax_id="12345678000100", status="active"
    )
    print(f"✅ PeopleCreate validation: {people_data.name}")

    phone_data = PhoneCreate(country_code="55", number="11987654321", type="mobile")
    print(f"✅ PhoneCreate validation: {phone_data.number}")

    email_data = EmailCreate(email_address="test@example.com", type="work")
