...
class TestEmailValidator:
    ...
    def test_validate_email_valid_formats(self):
        ...
        for email in valid_emails:
            assert validate_email_format(email) == True, f"Email {email} deveria ser válido"
    ...
    def test_validate_email_invalid_formats(self):
        ...
        for email in invalid_emails:
            assert validate_email_format(email) == False, f"Email {email} deveria ser inválido"
...
class TestPhoneValidator:
    ...
    def test_validate_phone_valid_formats(self):
        ...
        for phone in valid_phones:
            assert validate_phone_format(phone) == True, f"Telefone {phone} deveria ser válido"
    ...
    def test_validate_phone_invalid_formats(self):
        ...
        for phone in invalid_phones:
            assert validate_phone_format(phone) == False, f"Telefone {phone} deveria ser inválido"
...
class TestContactsQualityValidator:
    ...
    def test_validate_contacts_quality_partial_data(self):
        ...
        phones = [
            {"country_code": "55", "number": "11987654321", "type": "mobile"}
        ]
...
class TestValidatorsPerformance:
    ...
    def test_phone_validation_performance(self):
        ...
        # Cada validação deve ser muito rápida (menos de 1ms)
        assert avg_time < 0.001, f"Validação telefone muito lenta: {avg_time:.6f}s por validação"