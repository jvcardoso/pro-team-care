...
from app.utils.validators import (
    validate_email_format, validate_phone_format, validate_cep_format, 
    validate_address_completeness, validate_contacts_quality
)
...
class TestCNPJValidator:
    ...
    def test_validate_cnpj_edge_cases(self):
        ...
        for cnpj, expected in edge_cases:
            ...
            assert result == expected, f"CNPJ '{cnpj}' esperado {expected}, obtido {result}"
...
class TestCPFValidator:
    ...
    def test_validate_cpf_known_invalid_sequences(self):
        ...
        for cpf in invalid_sequences:
            assert validate_cpf(cpf) == False, f"CPF {cpf} (sequência) deveria ser inválido"
...
class TestEmailValidator:
    ...
    def test_validate_email_edge_cases(self):
        ...
        edge_cases = [
            ...
            ("very.long.email.address@very.long.domain.name.com", True),  # Longo mas válido
        ]
        
        for email, expected in edge_cases:
            result = validate_email(email)
            assert result == expected, f"Email '{email}' esperado {expected}, obtido {result}"
...
class TestPhoneValidator:
    ...
    def test_validate_phone_invalid_formats(self):
        ...
        for phone in invalid_phones:
            assert validate_phone(phone) == False, f"Telefone {phone} deveria ser inválido"
    ...
    def test_validate_phone_ddd_validation(self):
        ...
        for ddd in valid_ddds:
            ...
            assert validate_phone(phone) == True, f"Telefone com DDD {ddd} deveria ser válido"
        ...
        for ddd in invalid_ddds:
            ...
            assert validate_phone(phone) == False, f"Telefone com DDD {ddd} deveria ser inválido"
    ...
    def test_validate_phone_mobile_format(self):
        ...
        for mobile in valid_mobiles:
            assert validate_phone(mobile) == True, f"Celular {mobile} deveria ser válido"
        ...
        for mobile in invalid_mobiles:
            assert validate_phone(mobile) == False, f"Celular {mobile} deveria ser inválido"
...
class TestCEPValidator:
    ...
    def test_validate_cep_edge_cases(self):
        ...
        for cep, expected in edge_cases:
            ...
            assert result == expected, f"CEP '{cep}' esperado {expected}, obtido {result}"
...
class TestContactsQualityValidator:
    ...
    def test_validate_contacts_quality_good_data(self):
        ...
        phones = [
            {"country_code": "55", "number": "11987654321", "type": "mobile", "is_principal": True}
        ]
        emails = [
            {"email_address": "contact@company.com", "type": "work", "is_principal": True}
        ]
        addresses = [
            {
    ...
    def test_validate_contacts_quality_invalid_phone(self):
        ...
        phones = [
            {"country_code": "55", "number": "invalid", "type": "mobile"}
        ]
    ...
    def test_validate_contacts_quality_invalid_email(self):
        ...
        emails = [
            {"email_address": "invalid-email", "type": "work"}
        ]
    ...
    def test_validate_contacts_quality_multiple_principals(self):
        ...
        phones = [
            {"country_code": "55", "number": "11987654321", "type": "mobile", "is_principal": True},
            {"country_code": "55", "number": "21987654321", "type": "mobile", "is_principal": True}
        ]
...
class TestValidatorsIntegration:
    ...
    def test_all_validators_with_empty_input(self):
        ...
        for validator_func, empty_input in validators_and_inputs:
            ...
            assert result == False, f"{validator_func.__name__} deveria retornar False para entrada vazia"
    ...
    def test_all_validators_with_none_input(self):
        ...
        for validator_func, none_input in validators_and_inputs:
            ...
            assert result == False, f"{validator_func.__name__} deveria retornar False para entrada None"
            
    def test_validators_type_safety(self):
        """Test se os validadores lidam bem com tipos inesperados"""
        invalid_types = [123, [], {}, object()]
        
        validators = [validate_cnpj, validate_cpf, validate_email, validate_phone, validate_cep]
        ...
        for validator_func in validators:
            for invalid_input in invalid_types:
                try:
                    ...
                    assert result == False, f"{validator_func.__name__} deveria retornar False para tipo {type(invalid_input)}"
...
class TestValidatorsPerformance:
    ...
    def test_cnpj_validation_performance(self):
        ...
        assert avg_time < 0.001, f"Validação CNPJ muito lenta: {avg_time:.6f}s por validação"
    ...
    def test_email_validation_performance(self):
        ...
        # Cada validação deve ser muito rápida (menos de 1ms)
        assert avg_time < 0.001, f"Validação email muito lenta: {avg_time:.6f}s por validação"