      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-700 flex items-center justify-center">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-md w-full">
          <div className="text-center">
            ...
            <h2 className="text-lg font-medium text-gray-900 mb-2">Erro ao carregar dashboard</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Dashboard de Faturamento</h1>
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow border-2 border-dashed border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-colors text-center">
                ...
                <div className="font-medium text-gray-900 dark:text-white">Nova Fatura</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Criar fatura manual</div>
              </button>
              ...
              <button className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow border-2 border-dashed border-gray-200 hover:border-green-300 hover:bg-green-50 transition-colors text-center">
                <div className="text-2xl mb-2">⚡</div>
                <div className="font-medium text-gray-900 dark:text-white">Faturamento Automático</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Executar cobrança em lote</div>
              </button>
              ...
              <button className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow border-2 border-dashed border-gray-200 hover:border-purple-300 hover:bg-purple-50 transition-colors text-center">
                <div className="text-2xl mb-2">📊</div>
                <div className="font-medium text-gray-900 dark:text-white">Relatórios</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Exportar dados financeiros</div>
              </button>
            </div>
          </section>
          ...
          <section>
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-medium text-gray-900 dark:text-white">Faturas Recentes</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Contracts Status */}
            <section>
              <h2 className="text-lg font-medium text-gray-900 mb-4">Status dos Contratos</h2>
                ...
                {loading ? (
                  ...
                  <div className="divide-y divide-gray-200">
                    {contractsStatus.slice(0, 5).map((contract) => (
                      <div key={contract.contract_id} className="p-4 hover:bg-gray-50">
                        <div className="flex items-center justify-between">
                          <div>
                            <div className="font-medium text-gray-900 dark:text-white">{contract.client_name}</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400">{contract.contract_number}</div>
                          </div>
            ...
            {/* Upcoming Billings */}
            <section>
              <h2 className="text-lg font-medium text-gray-900 mb-4">Próximos Faturamentos</h2>
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                {loading ? (
                  <div className="p-6">
                    <div className="animate-pulse space-y-4">
                    ...
                    {upcomingBillings.slice(0, 5).map((billing) => (
                      <div key={billing.id} className="p-4 hover:bg-gray-50">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            <div className="font-medium text-gray-900 dark:text-white">
                              R$ {billing.amount_per_cycle.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                            </div>
                            <div className="text-sm text-gray-500 dark:text-gray-400">{billing.billing_cycle}</div>
                          </div>
                        </div>
                      </div>
                    ))}
