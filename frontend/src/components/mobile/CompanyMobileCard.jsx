...
import { Building, Calendar, Phone, Mail, MapPin, Edit, Eye, Trash2 } from 'lucide-react';

const CompanyMobileCard = ({ company, onView, onEdit, onDelete, getStatusBadge, getStatusLabel, formatTaxId }) => {
        ...
        <div className="flex items-start justify-between mb-2">
          <div className="flex-1 min-w-0">
            ...
            {company.trade_name && company.trade_name !== company.name && (
              <p className="text-sm text-gray-600 dark:text-gray-300 break-words">{company.trade_name}</p>
            )}
          </div>
