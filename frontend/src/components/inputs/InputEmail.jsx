...
const InputEmail = ({
  ...
  const getDomainSuggestion = (email) => {
    ...
    const suggestion = commonDomains.find(commonDomain => 
  ...
  const domainSuggestion = inputValue && !isValid ? getDomainSuggestion(inputValue) : null;
  ...
  return (
    <div className="space-y-1">
      ...
      {/* Mensagem de ajuda */}
      {!displayError && !domainSuggestion && inputValue && showValidation && isValid && isDirty && (
