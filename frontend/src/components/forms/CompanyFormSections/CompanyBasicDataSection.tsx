    ...
    <Card title="Dados da Empresa">
      <div className="space-y-6">
        ...
        <InputCNPJ
          ...
          onChange={(data: any) => onUpdatePeople('tax_id', data.target.value)}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Input
            ...
            onChange={(e) => onUpdatePeople('secondary_tax_id', e.target.value)}
            placeholder="123.456.789"
          />
          <Input
            label="Inscrição Municipal"
            value={formData.people.municipal_registration || ''}
            onChange={(e) => onUpdatePeople('municipal_registration', e.target.value)}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Input
            ...
            onChange={(e) => onUpdatePeople('incorporation_date', e.target.value)}
            type="date"
          />
        </div>
