...
export const Alert = ({ 
    ...
    const typeConfig = {
        success: {
            icon: CheckCircle,
            classes: "bg-green-50 border-green-200 text-green-800 dark:bg-green-900/20 dark:border-green-800 dark:text-green-400",
            iconClasses: "text-green-600 dark:text-green-400"
        },
        error: {
            icon: AlertCircle,
            classes: "bg-red-50 border-red-200 text-red-800 dark:bg-red-900/20 dark:border-red-800 dark:text-red-400",
            iconClasses: "text-red-600 dark:text-red-400"
        },
        warning: {
            icon: AlertTriangle,
            classes: "bg-yellow-50 border-yellow-200 text-yellow-800 dark:bg-yellow-900/20 dark:border-yellow-800 dark:text-yellow-400",
            iconClasses: "text-yellow-600 dark:text-yellow-400"
        },
        info: {
            icon: Info,
            classes: "bg-blue-50 border-blue-200 text-blue-800 dark:bg-blue-900/20 dark:border-blue-800 dark:text-blue-400",
