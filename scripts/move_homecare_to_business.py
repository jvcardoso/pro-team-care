...
async def move_homecare_to_business():
    ...
    try:
        async for db in get_db():
            ...
            print(f"📋 Movendo Home Care (ID: {home_care_id}) para Negócio (ID: {business_id})")
            ...
            await db.execute(update_submenus_level1_query, {
                "home_care_id": home_care_id
            })
            ...
            """)
            result = await db.execute(check_level1_query, {"home_care_id": home_care_id})
